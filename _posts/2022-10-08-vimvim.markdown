...
<div class="notranslate overflow-auto position-relative snippet-clipboard-content">
{% highlight %}
{% highlight %}git clone https://github.com/VundleVim/Vundle.vim.git ~/.vim/bundle/Vundle.vim
{% endhighlight %}
</div>
...
<div class="notranslate overflow-auto position-relative snippet-clipboard-content">
{% highlight %}
{% highlight %}cp dot_vimrc_for_vim8 ~/.vimrc
{% endhighlight %}
</div>
...
<div class="notranslate overflow-auto position-relative snippet-clipboard-content">
{% highlight %}
{% highlight %}:PluginInstall
{% endhighlight %}
</div>

<p dir="auto">就成功了</p>

<p dir="auto">{% highlight %}(没有.vimrc/dot_vimrc_for_vim8的话，就复制粘贴这端代码，到~/.vimrc,就可以看到行数和字体的颜色，也可以使用ctrl e查看历史编辑的文件等了){% endhighlight %}</p>
{% highlight %}filetype on{% endhighlight %}

{% highlight %}
{% highlight %}set langmenu=none
...
<p dir="auto">{% highlight %}{% highlight %}{% highlight %}{% highlight %}<img src="/uploads/ckeditor/pictures/676/image-20221102164105-1.png" style="height:1074px; width:1004px" />{% endhighlight %}{% endhighlight %}{% endhighlight %}{% endhighlight %}</p>
</div>
