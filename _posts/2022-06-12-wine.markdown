...
wget -nc <a class="external free" href="https://dl.winehq.org/wine-builds/winehq.key" rel="nofollow">https://dl.winehq.org/wine-builds/winehq.key </a>
 sudo mv winehq.key /usr/share/keyrings/winehq-archive.key </code>
</pre>
...
Saving to: &lsquo;winehq.key&rsquo;</code></pre>

<pre>
<code>winehq.key&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 100%[===================&gt;]&nbsp;&nbsp; 3.14K&nbsp; --.-KB/s&nbsp;&nbsp;&nbsp; in 0s&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;

2022-06-12 17:16:03 (32.2 MB/s) - &lsquo;winehq.key&rsquo; saved [3220/3220]

sudo mv /home/linlin/Downloads/winehq.key /usr/share/keyrings/winehq-archive.key</code></pre>
