...
<p>选择版本后，下载，安装：</p>
{% highlight html %}chmod +x selenium-server-4.4.0.jar
...
<p>脚本：</p>
{% highlight html %}require &#39;selenium-webdriver&#39; driver = Selenium::WebDriver.for :chrome driver.get &#39;https://selenium.dev&#39; driver.quit{% endhighlight %}
...
<p>解决：</p>
{% highlight html %}sudo apt-get install chromium-chromedriver{% endhighlight %}
<p>再次运行命令，执行脚本：</p>
