...
{% highlight %}
{% highlight %}<span style="color:#ffd700">docker</span> ps
...
{% highlight %}
{% highlight %}<span style="color:#ffd700">sudo docker pull vulnerables</span>/web-dvwa{% endhighlight %}

<p>启动DVWA Docker：</p>

{% highlight %}
{% highlight %}<span style="color:#ffd700">sudo</span> docker run -d -p <span style="color:#f5ab35">80</span>:<span style="color:#f5ab35">80</span> vulnerables/web-dvwa{% endhighlight %}

{% highlight %}
{% highlight %}sudo docker pull vulnerables/web-dvwa
...
{% highlight %}
{% highlight %}sudo docker run -d -p 80:80 vulnerables/web-dvwa
