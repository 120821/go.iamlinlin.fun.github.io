...
---
{% highlight %}
{% highlight %}<a href="https://www.cnblogs.com/mchina/archive/2013/04/19/3028573.html">查看index占用内存</a>
查看每个表的数据总数：
select count (*) from apples;{% endhighlight %}

{% highlight %}
{% highlight %}select count (*) from bananas;{% endhighlight %}

{% highlight %}
{% highlight %}select count (*) from cherries;{% endhighlight %}
...
{% highlight %}
{% highlight %}select * from apples where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}

<p><img height="440" src="/uploads/ckeditor/pictures/430/image-20220921092414-2.png" width="650" /></p>

{% highlight %}
{% highlight %}select * from bananas where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}
...
{% highlight %}
{% highlight %}select * from cherries where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}
...
{% highlight %}
{% highlight %}explain select * from apples where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}

<p><img height="243" src="/uploads/ckeditor/pictures/433/image-20220921092540-5.png" width="521" /></p>

{% highlight %}
{% highlight %}explain select * from bananas where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}

<p><img height="243" src="/uploads/ckeditor/pictures/434/image-20220921092558-6.png" width="521" /></p>

{% highlight %}
{% highlight %}explain select * from cherries where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}
...
<p>{% highlight %}explain select * from cherries where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}</p>
...
{% highlight %}
{% highlight %}select pg_size_pretty(pg_relation_size(&#39;apple_names&#39;));{% endhighlight %}
