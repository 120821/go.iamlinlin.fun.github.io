...
<pre>
<code>select count (*) from bananas;{% endhighlight %}

<pre>
<code>select count (*) from cherries;{% endhighlight %}
...
<pre>
<code>select * from apples where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}

<p><img height="440" src="/uploads/ckeditor/pictures/430/image-20220921092414-2.png" width="650" /></p>

<pre>
<code>select * from bananas where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}
...
<pre>
<code>select * from cherries where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}
...
<pre>
<code>explain select * from apples where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}

<p><img height="243" src="/uploads/ckeditor/pictures/433/image-20220921092540-5.png" width="521" /></p>

<pre>
<code>explain select * from bananas where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}

<p><img height="243" src="/uploads/ckeditor/pictures/434/image-20220921092558-6.png" width="521" /></p>

<pre>
<code>explain select * from cherries where first_name = &#39;jim&#39; or last_name = &#39;jim&#39;;{% endhighlight %}
...
<pre>
<code>select pg_size_pretty(pg_relation_size(&#39;apple_names&#39;));{% endhighlight %}
...
<pre>
<code>select pg_size_pretty(pg_relation_size(&#39;banana_names&#39;));{% endhighlight %}
