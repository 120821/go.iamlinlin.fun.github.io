...
{% highlight html %}cat package.json
{
&nbsp; &quot;dependencies&quot;: {
...
<p>需要编译的contract</p>
{% highlight html %}cat Demo.sol<br />
...
{% highlight html %}cat compile.js<br />
...
main().then( () =&gt; process.exit(0) ){% endhighlight %}
<p>运行node compile.js，</p>
<p>会生成需要的abi和bytecode</p>
{% highlight html %}cat&nbsp; Demo.json<br />
{<br />
&nbsp; &quot;abi&quot;: [<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &quot;anonymous&quot;: false,<br />
...
<p>部署的脚本：</p>
{% highlight html %}cat deploy.js<br />
