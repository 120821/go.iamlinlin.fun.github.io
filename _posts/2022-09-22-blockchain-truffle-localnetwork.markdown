...
<p>turffle的使用：</p>
<p>运行部署</p>
{% highlight html %}truffle deploy --network=ganache{% endhighlight %}
<p>运行某个脚本</p>
{% highlight html %}truffle exec &lt;yourfile.js&gt;{% endhighlight %}
<p>查看帮助</p>
{% highlight html %}truffle help{% endhighlight %}
<p>仅仅运行某个migration</p>
{% highlight html %}truffle migrate --f 9 --network=ganache{% endhighlight %}
<p>$truffle develop</p>
...
{% highlight html %}truffle deploy --network ganacheNet --verbose-rpc --interactive --reset{% endhighlight %}
