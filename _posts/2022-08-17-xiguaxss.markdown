...
{% highlight %}
{% highlight %}bundle update nokogiri
...
<div style="background:#eeeeee;border:1px solid #cccccc;padding:5px 10px;">4.2.2安装：{% highlight %}bin/rails webpacker:install{% endhighlight %}</div>
...
<p>{% highlight %}&lt;link href=&quot;https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/5.2.0/css/bootstrap.css&quot; rel=&quot;stylesheet&quot;&gt;{% endhighlight %}</p>
