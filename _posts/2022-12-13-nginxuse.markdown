...
{% highlight %}
{% highlight %}nginx -s stop{% endhighlight %}

<div style="background:#eeeeee; border:1px solid #cccccc; padding:5px 10px">{% highlight %}nginx 配置文件：{% endhighlight %}</div>

{% highlight %}
{% highlight %}cd /etc/nginx
...
{% highlight %}
{% highlight %}cd /etc/nginx/sites-enabled#
