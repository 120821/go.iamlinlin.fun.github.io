...
{% highlight html %}asdf plugin-list{% endhighlight %}
<p>2.卸载asdf&nbsp; mysql 以及插件</p>
{% highlight html %}asdf uninstall mysql{% endhighlight %}
{% highlight html %}asdf plugin-remove mysql{% endhighlight %}
{% highlight html %}<span style="color:#ffd700">asdf</span> plugin-list
...
{% highlight html %}<span style="color:#ffd700">asdf</span> global mysql system{% endhighlight %}
<p>如果出现了：</p>
{% highlight html %}which mysql
